...
| Python | Syntax/import compilation | `python -m compileall -q NiimPrintX` |
| Python metadata | Poetry validity | `poetry check` |
| Python tests | Unit, integration, and minimum 80% coverage | `poetry run pytest` |
| Python lint | Ruff static checks | `poetry run ruff check NiimPrintX tests` |
| Python format | Ruff formatting | `poetry run ruff format --check NiimPrintX tests` |
